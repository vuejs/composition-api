...
JSX is now support in the official [vuejs/jsx](https://github.com/vuejs/jsx). You can enabled it following [this documentation](https://github.com/vuejs/jsx/tree/dev/packages/babel-preset-jsx#usage). A community maintained version can be found in [babel-preset-vca-jsx](https://github.com/luwanquan/babel-preset-vca-jsx) by [@luwanquan](https://github.com/luwanquan).
